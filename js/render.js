...
const resumeSlideShow = () => {
  ...
  document.title = 'Henry Photography';
...
const renderMain = (page = 'events') => {
  PAGE = page;
  document.title = `Henry Photography - ${page}`;
  ...
  if (page === 'portraits') {
    ...
    const imgSrc = page === 'events' ? './img/e_title2.jpg' : './img/o_title1.jpg';
